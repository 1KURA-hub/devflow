...
type Notification struct {
	ID        uint64    `gorm:"primaryKey;autoIncrement;index:idx_notifications_user_read_created,priority:4;index:idx_notifications_user_created,priority:3" json:"id"`
	...
	CreatedAt time.Time `gorm:"type:datetime(6);index:idx_notifications_user_read_created,priority:3;index:idx_notifications_user_created,priority:2" json:"created_at"`
}
