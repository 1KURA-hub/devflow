...
type Comment struct {
	ID        uint64         `gorm:"primaryKey;autoIncrement;index:idx_comments_post_created,priority:3;index:idx_comments_user_created,priority:3" json:"id"`
	...
	CreatedAt time.Time      `gorm:"type:datetime(6);index:idx_comments_post_created,priority:2;index:idx_comments_user_created,priority:2" json:"created_at"`
